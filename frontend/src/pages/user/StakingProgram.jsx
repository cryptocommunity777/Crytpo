...
import StakeCctModal from '../../components/modals/StakeCctModal';
import WithdrawCctModal from '../../components/modals/WithdrawCctModal';
//import ReinvestCompoundModal from '../../components/modals/ReinvestCompoundModal';
...
const StakingProgram = () => {
    const [stats, setStats] = useState({ 
        ...
        topUpDate: null,
        createdAt: null,
        // 🔥 NAYE COMPOUND WALLETS INITIAL STATE ME ADD KIYE
        cctCompoundIncome: 0, 
        cctCompoundDirectIncome: 0,
        cctCompoundLevelIncome: 0,
        totalCompoundStaked: 0
    });
...
{/* 
                    <button 
                        ...
                        className="bg-purple-600 hover:bg-purple-700 text-white font-black py-3 rounded-xl transition-all shadow-sm active:scale-[0.98] uppercase tracking-widest text-[11px] md:text-sm"
                    >
                        REINVEST
                    </button> */}
            ...
            {isWithdrawOpen && (
                <WithdrawCctModal 
                    ...
                    // 🔥 NAYE COMPOUND WALLETS YAHAN PASS KIYE HAIN 🔥
                    cctCompoundIncome={stats.cctCompoundIncome}
                    cctCompoundDirectIncome={stats.cctCompoundDirectIncome}
                    cctCompoundLevelIncome={stats.cctCompoundLevelIncome}
