...
// useEffect(() => {
//   const STAKING_START_DATE = new Date("2026-07-01T00:01:00+05:30"); // IST

//   const checkStakingStatus = () => {
//     setStakingStarted(new Date() >= STAKING_START_DATE);
//   };

//   checkStakingStatus();

//   const interval = setInterval(checkStakingStatus, 1000);
...
//     return showMessage(
//       "Staking Not Started",
//       "Staking will start on 1 July 2026 at 12:01 AM (IST).",
//       "error"
//     );
//   }
...
//                 <button
//   onClick={handleStake}
//   disabled={loading || !userInfo || !stakingStarted}
//   className={`w-full py-2.5 rounded-lg font-black text-xs md:text-sm flex items-center justify-center gap-2 transition-all shadow-sm ${
//     loading || !userInfo || !stakingStarted
